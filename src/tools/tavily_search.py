...
class TavilySearchClient:
    ...
    # 뷰티 산업 기본 키워드
    BEAUTY_KEYWORDS = [
        "K-Beauty", "Korean skincare", "LANEIGE", "COSRX",
        "lip sleeping mask", "skincare routine", "beauty trends",
        "Amazon bestseller beauty", "skincare ingredient"
    ]
    ...
    async def search_beauty_news(
        ...
        logger.info(f"Beauty news search: {len(unique_results)} unique results from {len(queries)} queries")
