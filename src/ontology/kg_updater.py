"""
Knowledge Graph Data Loading Mixin
===================================
KnowledgeGraph의 데이터 로딩 기능을 담당하는 믹스인 클래스

## 주요 기능
1. 크롤링 데이터 로딩 (Amazon BSR)
2. 지표 데이터 로딩 (KPI)
3. 카테고리 계층 구조 로딩
4. 감성 데이터 로딩 (AI Summary, Sentiment Tags)
5. 브랜드 소유권 데이터 로딩 (Amorepacific)
"""
...
class KGUpdaterMixin:
    """
    KnowledgeGraph의 데이터 로딩 기능을 제공하는 믹스인
