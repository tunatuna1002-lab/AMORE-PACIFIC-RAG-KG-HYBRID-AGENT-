...
class AlertAgent:
    ...
    def __init__(
        ...
        # 통계
        self._stats = {"total_alerts": 0, "emails_sent": 0, "emails_failed": 0}
    ...
    async def send_daily_summary(
        ...
        if not recipients:
            return SendResult(success=True, sent_to=[], failed=[], message="일일 요약 수신자 없음")
    ...
    def clear_old_alerts(self, hours: int = 24) -> int:
        ...
        old_ids = [a.id for a in self._alerts if a.created_at.timestamp() < cutoff]
