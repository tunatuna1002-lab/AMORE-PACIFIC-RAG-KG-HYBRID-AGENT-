...
| 10-3 | SQLite 지표를 질의 엔티티에 맞춰 컨텍스트에 싣기 (평가는 as_of 고정) | done | (이 커밋) | src/rag/metric_facts.py. 무비용 점검: lg049·lg048·lg195·lg076 골드 수치가 컨텍스트에 들어감, lg072는 상위 5개 상한으로 불가. judge 근거성 컨텍스트에 DB 사실 포함 → groundedness v9.1과 비교 불가 |
