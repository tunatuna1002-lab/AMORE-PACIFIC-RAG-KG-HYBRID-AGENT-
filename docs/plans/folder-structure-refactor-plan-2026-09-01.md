...
| 일시 | Phase | 커밋 | 내용 |
|------|-------|------|------|
| 2026-09-02 | 0 | c4797a0, 3c0c664, d8b023a | `.env.test`·conftest 격리·싱글턴 autouse 리셋, `KG_PERSIST_PATH`, tests 루트 잔재 정리, adapters/orchestrators 삭제, 루트 메타·docs 분류, 락파일, pyproject 정리, ruff UP042, 골든셋 record/replay 게이트, 특성화 테스트 205개 |
| 2026-09-02 | 1 | d8a49d0 | D10 신뢰도 스케일 0~1, 가드 거절 저신뢰·캐시 제외 |
| 2026-09-02 | 1 | b0ddbfa | D1 D3 D5 D6 D11 D12 D13 D24 D27 (배치·에이전트·코어) |
| 2026-09-02 | 1 | 14164c7 | D2 D4 D14 D17 D18 D25 D26 + 브랜드 대소문자 조회 (`src/shared/units.py` 신설) |
| 2026-09-02 | 1 | 39fd2d0 | D7 D8 D19 D20 D22 D23 + 중복 모델·JWT 제거 (API) |
