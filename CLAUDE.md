...
4. TODO.md를 체크리스트로 관리하고, 작업 완료 시마다 체크하세요.
5. HANDOFF.md는 컨텍스트 70% 시점과 작업 완료 시 반드시 업데이트하세요.
...
1단계: 아래 파일들만 읽고 현재 구조를 파악해:
- [대상 파일 5-10개 나열]

2단계: TODO.md를 체크리스트로 만들어:
- [ ] 작업항목 1
- [ ] 작업항목 2
- ...

3단계: 각 TODO 항목의 검증 테스트를 먼저 작성해.

이 세션에서는 구현하지 마. 프레임워크만 세팅해.
```

### 두 번째 세션부터

```
HANDOFF.md와 TODO.md를 읽고, 첫 번째 미완료 항목부터 구현해.
완료할 때마다 TODO.md에 체크하고 테스트 실행해.
```
